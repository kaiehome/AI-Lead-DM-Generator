...
export function SimplifiedLeadForm({ onSubmit, loading = false, initialData }: SimplifiedLeadFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-blue-600">
          Adding a LinkedIn URL helps AI generate more personalized messages
        </p>
      </div>
